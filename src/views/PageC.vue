...
<template>
    <div>
      <h1>PageC</h1>
      <p>clamp(15, 0, 10): {{ clamped }}</p>
      <p>formatDate(new Date(2023, 0, 15)): {{ formatted }}</p>
      <p>parseDate("2023-01-15"): {{ parsed }}</p>
      <p>getDayOfWeek(new Date(2023, 0, 15)): {{ dayOfWeek }}</p>
      <p>isWeekend(new Date(2023, 0, 15)): {{ weekend }}</p>
    </div>
  </template>
